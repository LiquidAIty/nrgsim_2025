...
void click(int row,int col)
{
	...
	else if(Text == "Yahoo") panelSet(row,col,"EOD",0,0,0); 
	else if(Text == "EOD") panelSet(row,col,"AlphaVantage",0,0,0); 
